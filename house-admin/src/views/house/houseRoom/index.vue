  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="首页推荐" align="center" prop="recommend">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.house_recommend_status" :value="scope.row.recommend"/>
        </template>
      </el-table-column>
      <el-table-column
        fixed="right"
    ...
    >
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-row>
          ...
          <el-select v-model="form.recommend" placeholder="请选择首页推荐" style="width: 100%">
            <el-option
              v-for="dict in dict.type.house_recommend_status"
              :key="dict.value"
              :label="dict.label"
...
export default {
  name: "HouseRoom",
  dicts: ["sys_notice_status", "house_recommend_status"],
