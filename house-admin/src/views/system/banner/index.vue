  ...
  <div class="app-container">
    <el-row :gutter="10" class="mb5">
      ...
      <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px" class="el-form-search">
                        <el-form-item label="轮播图标题" prop="title" class="el-form-search-item">
                            <el-input
                        ...
                        <el-form-item label="轮播图链接" prop="link" class="el-form-search-item">
                            <el-input
                        ...
                        <el-form-item label="轮播图状态" prop="status" class="el-form-search-item">
                            <el-select v-model="queryParams.status" placeholder="请选择轮播图状态" clearable size="mini">
                                <el-option
    ...
    <el-table :height="tableHeight" v-loading="loading" :data="bannerList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="轮播图链接" align="center" prop="link" />
      <el-table-column label="轮播图图片" align="center" prop="image" width="100">
        <template slot-scope="scope">
          <image-preview :src="scope.row.image" :width="30" :height="30"/>
        </template>
      </el-table-column>
      <el-table-column label="轮播图状态" align="center" prop="status">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.mall_goods_shelf" :value="scope.row.status"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body :close-on-click-modal="false" v-dialogDrag>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="轮播图链接" prop="link">
          <el-input v-model="form.link" placeholder="请输入轮播图链接" />
        </el-form-item>
