...
<template>
	<view class="ithui-content">
		<view class="upload">
			...
			<view class="upload-box">
				<view class="upload-item">
					<u-upload class="u-upload" customBtn="true"  @afterRead="afterRead" :fileList="uploadA" @delete="deletePic" name="uploadA" multiple
						:maxCount="1" width="145" height="115">
						<image slot="addBtn" src="@/static/style-two/sfzzm.png" style="width: 130px;height: 90px;padding: 15px;">
						</image>
					</u-upload>
					<view class="intro">上传身份证正面</view>
				</view>
				<view class="upload-item">
					<u-upload class="u-upload"  customBtn="true"  @afterRead="afterRead" :fileList="uploadB" @delete="deletePic" name="uploadB" multiple
						:maxCount="1" width="145" height="115">
						<image slot="addBtn"  src="@/static/style-two/sfzfm.png" style="width: 130px;height: 90px;padding: 15px;">
						</image>
					</u-upload>
		...
		<view class="submit">
			<u-button @click="submit" shape="circle" type="primary">身份认证</u-button>
		</view>
	</view>
</template>
